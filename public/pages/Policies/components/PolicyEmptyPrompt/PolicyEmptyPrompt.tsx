...
const filterText = "There are no policies matching your applied filters. Reset your filters to view your policies.";
const emptyPolicyText = "There are no existing policies. Create a policy to apply to your indices.";
